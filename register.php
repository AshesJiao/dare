...
<div class="header_div">
 ...
 <div id="main">
<div id="from">
<h2 style="font-size: 35px; text-align: center; color: #FF6666;">登录</h2>
<form name="loginForm" action="registertion.php" method="post">  
<table>
      <tr>
        <td class="mane">账号</td>
        <td><input type="text" name ="username" class="tt tex3" /></td>
	 </tr>
     <tr>
        <td class="pass">密码</td>
        <td><input type="password" name="password" class="tt upwd"/></td>
     </tr>
     <td>&nbsp;</td>
        <td><input type="submit" value="登录"  class="ba"/></td>
    </tr>
    <tr>
    <td>&nbsp; </td>
    <td> <h2 class="header"><a href="login.php">注册</a>&nbsp;&nbsp;&nbsp;<a href="*">忘记密码</a></h2></td>
    </tr>
    </table>
    </form>
    </div>
