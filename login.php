...
<div class="header_div">
 ...
 <div id="main">
<div id="from">
    <h2 class="header"><a href="login.php">邮箱注册</a></h2>
    <form name="loginForm" action="AddUser.php" method="post">  
<table>
      <tr>
        <td class="left">邮箱</td>
        <td><input type="text" name="email" placeholder="邮箱" class="tt tex3" /></td>
	 </tr>
      <tr>
        <td class="left">昵称</td>
        <td><input type="text" name="username" placeholder="昵称" class="tt tex1" /></td>
    </tr>
     <tr>
        <td class="left">密码设定</td>
        <td><input type="password" name="password" placeholder="密码" class="tt upwd"/></td>
     </tr>
    <td class="left">&nbsp;</td>
    <td class="brand">
          <label for="xieyi"><input  type="checkbox"  id="xieyi" >我已阅读并同意相关注册协议 ▼</label></td>
             <tr>
        <td>&nbsp;</td>
        <td><input type="submit" value="注册"  class="bt"/></td>
    </tr>
    </table>
    </form>
    </div>
